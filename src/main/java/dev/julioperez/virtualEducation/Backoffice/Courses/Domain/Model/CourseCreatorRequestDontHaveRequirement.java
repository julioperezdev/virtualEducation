...
public class CourseCreatorRequestDontHaveRequirement extends DomainError {

    public CourseCreatorRequestDontHaveRequirement(CourseCreatorRequest courseCreatorRequest) {
